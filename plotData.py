...
class plotData:
    ...
    def __init__(self):
        ...
        self.handle.append(myPlot(self.ax[3], xlabel='t(s)', ylabel='tau(N-m)'))

    def updatePlots(self, t, z_ref, states, ctrl, h_ref):
        '''
            Add to the time and data histories, and update the plots.
        '''
        # update the time history of all plot variables
        self.time_history.append(t)  # time
        self.zref_history.append(z_ref[0])  # reference base position
        self.z_history.append(states[0])    # z position
        self.href_history.append(h_ref[0])
        self.h_history.append(states[1])    # h position
