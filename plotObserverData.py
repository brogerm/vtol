...
class plotObserverData:
    ...
    def __init__(self):
        ...
        self.handle.append(myPlot(self.ax[4], ylabel='theta_dot (deg/s)'))
        self.handle.append(myPlot(self.ax[5], xlabel='t(s)', ylabel='h_dot (m/s)'))
    ...
    def updatePlots(self, t, x, x_hat):
        ...
        self.handle[4].updatePlot(self.time_history, [self.theta_dot_history, self.theta_hat_dot_history])
        self.handle[5].updatePlot(self.time_history, [self.h_dot_history, self.h_hat_dot_history])
